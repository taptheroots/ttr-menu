...
const menuData = [
    ...
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Fresh Creamy Paneer", price: "350", img: "images/Food/Indo European Parantha Bowls/Fresh Cremy paneer.jpg", desc: "Fresh, creamy paneer stuffed in soft parathas, served warm for a comforting, wholesome bowl rooted in purity and rustic goodness" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Vegetable Keema 🌶️", price: "280", img: "images/Food/Indo European Parantha Bowls/Vegetable keema.jpg", desc: "Wholesome veggie keema filled in warm parathas, delivering a savory, textured bowl bursting with earthy spices" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Tandoor Garden 🌶️ ⭐", price: "290", img: "images/Food/Indo European Parantha Bowls/Tandoori Garden.jpg", desc: "Charred garden-fresh veggies kissed by tandoor flames, wrapped in soft parathas—smoky, vibrant, and soulfully organic" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Chickpeas Khoya Bite", price: "270", img: "images/Food/Indo European Parantha Bowls/Chickpeas Khoya bites.jpg", desc: "Wholesome chana and rich khoya bites wrapped in soft parathas, creating a sweet-spicy, nourishing bowl full of earthy indulgence" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Mava Mirchi ⭐", price: "315", img: "images/Food/Indo European Parantha Bowls/Mava Mirchi.jpg", desc: "Spiced mava-stuffed green chilies wrapped in soft parathas, offering a bold, earthy bowl with rich, rustic flavors and organic warmth" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Protein Delight (Low fat Paneer) ⭐", price: "350", img: "images/Food/Indo European Parantha Bowls/Paneer Delight.jpg", desc: "Soft parathas filled with spiced high protein, low fat paneer—creamy, comforting, rich in flavor, warmth, and pure organic indulgence" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Umami Mushroom ⭐", price: "335", img: "images/Food/Indo European Parantha Bowls/Luscious Mushroom.jpg", desc: "Delicate mushrooms infused with umami richness, wrapped in tender parathas—earthy, wholesome, comforting, and organically satisfying" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Matar Magic Dal", price: "300", img: "images/Food/Indo European Parantha Bowls/Matar Magic Dal.jpg", desc: "Green peas and yellow dal slow-cooked with aromatic spices—a soul-soothing, flavorful experience packed with organic warmth" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Chilli Paneer 🌶️", price: "345", img: "images/Food/Indo European Parantha Bowls/Chilli Paneer.jpg", desc: "Fiery chilli paneer tossed in TTR's secret spice blend—bold, aromatic, and soulful" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Green Harvest", price: "230", img: "images/Food/Indo European Parantha Bowls/Green Harvest.jpg", desc: "Exotic veggies blending vibrant flavors & nourishing goodness for a wholesome, deliciously healthy experience" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Mediterranean Tomato Broccoli", price: "279", img: "images/Food/Indo European Parantha Bowls/Mediterranean tomato brocolli.jpeg", desc: "Sun-kissed tomatoes and tender broccoli tossed in Mediterranean herbs and olive oil, wrapped in warm organic parathas — light, vibrant, and wholesomely satisfying" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Guacamole", price: "349", img: "images/Food/Indo European Parantha Bowls/Guacamole parantha.jpeg", desc: "Creamy, freshly made guacamole with ripe avocado, lime, and herbs, wrapped in warm organic parathas — smooth, rich, and deliciously wholesome" },
    // ── DESI PARATHA BOWLS ────────────────────────────────────
    { section: "food", cat: "Desi Paratha Bowls", name: "Shahi Paneer Makhani 👑", price: "380", img: "images/Food/Desi Parantha Bowls/Shahi paneer makhni parantha bowl.jpeg", desc: "Velvety shahi paneer slow-cooked in a rich, aromatic makhani gravy — regal, buttery, and soul-satisfying, wrapped in warm organic parathas" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Palak Paneer 💪 (High Protein) 👨‍🍳", price: "280", img: "images/Food/Desi Parantha Bowls/Palak paneer parantha bowl.jpeg", desc: "Farm-fresh spinach blended with soft organic paneer — packed with protein, earthy green goodness, and nourishing desi warmth" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Malai Kofta", price: "310", img: "images/Food/Desi Parantha Bowls/Malai kofta parantha bowl.jpeg", desc: "Melt-in-the-mouth koftas simmered in a creamy, mildly spiced malai gravy — indulgent, rich, and rooted in classic desi comfort" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Kaju Curry", price: "320", img: "images/Food/Desi Parantha Bowls/Kaju curry parantha bowl.jpeg", desc: "Plump cashews slow-cooked in a velvety, aromatic curry — nutty, luxurious, and deeply satisfying with every wholesome bite" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Rajma Chola Masala", price: "260", img: "images/Food/Desi Parantha Bowls/Rajma chola masala parantha bowl.jpeg", desc: "A hearty, spiced blend of slow-cooked rajma and chola, served in a warm paratha bowl for the ultimate desi comfort" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Kadhai Paneer ⭐ (Chef Special) 👨‍🍳", price: "329", img: "images/Food/Desi Parantha Bowls/Kadhai paneer parantha bowl.jpeg", desc: "Paneer tossed in a bold, smoky kadhai masala with bell peppers and whole spices — the chef's pride, fiery, and organically irresistible" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Butter Paneer Masala", price: "320", img: "images/Food/Desi Parantha Bowls/Butter paneer masala parantha bowl.jpeg", desc: "Tender paneer cubes bathed in a luscious, buttery tomato masala — smooth, warming, and a timeless desi classic" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Mix Veg", price: "299", img: "images/Food/Desi Parantha Bowls/Mix veg parantha bowl.jpeg", desc: "A wholesome medley of seasonal vegetables slow-cooked in desi spices — vibrant, hearty, and rooted in the goodness of nature" },

    // ── RICE BOWLS ────────────────────────────────────────────
    { section: "food", cat: "Rice Bowls", name: "Green Garden Fresh", price: "330", img: "images/Food/Rice Bowls/Green Garden Fresh.jpeg", desc: "Garden-fresh exotic veggies sautéed and served over organic rice—colorful, crunchy, and earthy" },
    { section: "food", cat: "Rice Bowls", name: "Crispy Mushroom (Fry/Sauté)", price: "345", img: "images/Food/Rice Bowls/Crispy mushroom rice bowl.jpeg", desc: "Fried/sauté mushrooms over fragrant rice, infused with organic spices and herbs, with two infused gravies" },
    { section: "food", cat: "Rice Bowls", name: "Corn Affair (Fry/Sauté)", price: "310", img: "images/Food/Rice Bowls/Corn Afire.jpeg", desc: "Golden corn and baby corn with fire-roasted spices over organic rice—smoky-sweet, rustic, and naturally comforting" },
    { section: "food", cat: "Rice Bowls", name: "Exotic Veggie (Fry/Sauté)", price: "345", img: "images/Food/Rice Bowls/Veggie exotic rice bowl.jpeg", desc: "Farm-fresh exotic veggies, baby corn, mushrooms tossed in spices over organic rice" },
    { section: "food", cat: "Rice Bowls", name: "Thai Green Curry 🌶️", price: "335", img: "images/Food/Rice Bowls/Thai green curry.jpeg", desc: "Thai green curry infused with coconut milk with exotic veggies over organic rice—creamy, herbal, and soulfully nourishing" },
    { section: "food", cat: "Rice Bowls", name: "Shahi Paneer Makhani", price: "370", img: "images/Food/Rice Bowls/Shahi paneer makhni.jpeg", desc: "Creamy shahi paneer in buttery makhni gravy over organic rice—regal, spiced, and soulfully nourishing" },
    { section: "food", cat: "Rice Bowls", name: "Rajma Chola Masala", price: "260", img: "images/Food/Rice Bowls/Rajma chola masala.jpeg", desc: "Hearty rajma and chola slow-cooked in aromatic spices over organic rice—comforting, flavorful, and rooted in desi goodness" },
    { section: "food", cat: "Rice Bowls", name: "Chilli Paneer 🌶️", price: "340", img: "images/Food/Rice Bowls/Chilli paneer.jpeg", desc: "Tender organic paneer in fiery chilli sauce over wholesome rice—bold, spicy Indo-Chinese fusion" },
    { section: "food", cat: "Rice Bowls", name: "Ragi Manchurian 🌶️", price: "250", img: "images/Food/Rice Bowls/Ragi Manchurian.jpeg", desc: "Crispy ragi manchurian over organic rice, blending ancient grains with zesty spices" },
    { section: "food", cat: "Rice Bowls", name: "Mughlai Dry Fruit Delight", price: "420", img: "images/Food/Rice Bowls/Mughlai Dry fruit.jpeg", desc: "Mughlai spices and dry fruits slow-cooked over organic rice—warm, nutty, aromatic indulgence" },
    ...
    { section: "food", cat: "Quick Bites", name: "Chilli Paneer Dry", price: "190", img: "images/Food/Quick Bites/Chilli paneer dry.jpeg", desc: "Classic preparation of paneer with sauces" },
    // { section: "food", cat: "Quick Bites", name: "Chilli Ragi Manchurian Dry", price: "170", img: "images/Food/Quick Bites/Ragi Manchurian dry.jpeg", desc: "Classic preparation of ragi manchurian with sauces" },
    // { section: "food", cat: "Quick Bites", name: "Onion Rings ⭐", price: "150", img: "images/Food/Quick Bites/Onion rings.jpeg", desc: "Sourdough coated onion rings, lightly fried in organic peanut oil" },
    // { section: "food", cat: "Quick Bites", name: "Exotic Veg Crunch", price: "180", img: "images/Food/Quick Bites/Veggie exotic toast.jpeg", desc: "Seasonal exotic veggies, sourdough coated, lightly fried in organic peanut oil" },
    // { section: "food", cat: "Quick Bites", name: "Crispy Mushroom", price: "160", img: "images/Food/Quick Bites/Crispy mushroom.jpeg", desc: "Fresh mushrooms, sourdough coated, lightly fried in organic peanut oil" },
    { section: "food", cat: "Quick Bites", name: "Makhana Bhel", price: "260", img: "images/Food/Quick Bites/Makhana bhel.jpeg", desc: "Crispy roasted makhana tossed with fresh veggies, and TTR's signature spice blend — light, crunchy, and guilt-free snacking at its best" },
    { section: "food", cat: "Quick Bites", name: "Shahi Paneer Tikka", price: "299", img: "images/Food/Quick Bites/Shahi paneer tikka.jpeg", desc: "Tender paneer cubes marinated in a rich, aromatic shahi spice mix and grilled to perfection — smoky, creamy, and royally indulgent in every bite" },
    { section: "food", cat: "Quick Bites", name: "Galouti Kebab", price: "229", img: "images/Food/Quick Bites/Galauti kebab.jpeg", desc: "Melt-in-the-mouth chana galouti kebab — soft, richly spiced, and slow-cooked with aromatic desi masalas for a truly royal bite" },
    { section: "food", cat: "Quick Bites", name: "Protein Galouti Kebab 💪", price: "259", img: "images/Food/Quick Bites/Protein galauti kebab.jpeg", desc: "A high-protein twist on the classic — soft, melt-in-the-mouth kebab crafted with fresh paneer and aromatic desi spices, indulgent yet nourishing in every bite" },

    // ── PIZZA ─────────────────────────────────────────────────────
    // — Sourdough —
    { section: "food", cat: "Pizza", name: "Margherita", price: "120 / 240", img: "images/Food/Pizza/Margherita.jpeg", desc: "🫓 Sourdough crust | Fresh tomato sauce, Mozzarella, virgin Olive oil" },
    { section: "food", cat: "Pizza", name: "Farmhouse", price: "260 / 416", img: "images/Food/Pizza/Farmhouse.jpeg", desc: "🫓 Sourdough crust | Mozzarella, Capsicum, Onion, Tomato, Mushroom" },
    { section: "food", cat: "Pizza", name: "Cheese N Corn", price: "200 / 320", img: "images/Food/Pizza/Cheese N Corn.jpeg", desc: "🫓 Sourdough crust | Cheesy tomato sauce, Mozzarella, American Sweet corn" },
    { section: "food", cat: "Pizza", name: "Mushroom Margherita", price: "210 / 330", img: "images/Food/Pizza/Mushroom Margherita.jpeg", desc: "🫓 Sourdough crust | Cheesy tomato sauce, Mozzarella, grilled mushroom" },
    { section: "food", cat: "Pizza", name: "Indi Tandoori Paneer 🌶️", price: "300 / 480", img: "images/Food/Pizza/Indie-Tandoori paneer.jpeg", desc: "🫓 Sourdough crust | Tandoori sauce, Paneer, Curd, Tandoori masala, Onion, Capsicum" },

    // — TTR Special Crisp —
    { section: "food", cat: "Pizza", name: "TTR Tomato Basil Crisp", price: "210 / 320", img: "images/Food/Pizza/TTR Tomato Basil Crisp.jpeg", desc: "🌿 Thin wheat crust, papad-like crunch OR regular wheat crust | Tomato basil sauce, cherry tomatoes, olives" },
    { section: "food", cat: "Pizza", name: "TTR Veggie Exotic Crisp", price: "210 / 350", img: "images/Food/Pizza/TTR Veggie Exotic Crisp.jpeg", desc: "🌿 Thin wheat crust, papad-like crunch OR regular wheat crust | Fresh pizza sauce, seasonal exotic veggies" },
    { section: "food", cat: "Pizza", name: "TTR Makhani Paneer Crisp ⭐", price: "210 / 300", img: "images/Food/Pizza/TTR Makhni Paneer crisp.jpeg", desc: "🌿 Thin wheat crust, papad-like crunch OR regular wheat crust | Makhni sauce, fresh paneer with Indian twist" },


    // ── SOYA BOWLS ────────────────────────────────────────────
    { section: "food", cat: "Soya Bowls", name: "Chilli Garlic Soya Chaap ⭐", price: "265 / 320", img: "images/Food/Soya Bowls/Chilli garlic soya.jpeg", desc: "Chilli garlic soya chaap stir-fried spicy savory Indo-Chinese. (Paratha / Rice)" },
    { section: "food", cat: "Soya Bowls", name: "Malai Soya Chaap", price: "370 / 390", img: "images/Food/Soya Bowls/Malai soya.jpeg", desc: "Malai soya chaap cooked creamy with mild spices and rich flavor. (Paratha / Rice)" },
    { section: "food", cat: "Soya Bowls", name: "Tandoori Soya Chaap 🌶️", price: "330 / 370", img: "images/Food/Soya Bowls/Tandoori soya.jpeg", desc: "Marinated, grilled smoky chaap with in-house tandoori sauce. (Paratha / Rice)" },
    { section: "food", cat: "Soya Bowls", name: "Crispy Soya 65", price: "320 / 340", img: "images/Food/Soya Bowls/Crispy soya 65.jpeg", desc: "Spiced, fried, crunchy, tangy, flavorful. (Paratha / Rice)" },
    ...
    { section: "food", cat: "Pasta/Noodles", name: "Cheese Sauce Pasta ⭐", price: "320", img: "images/Food/Pasta_Noodles/White cheese sauce pasta.jpeg", desc: "Pasta tossed with in-house creamy cheese sauce and Italian spices" },
    { section: "food", cat: "Pasta/Noodles", name: "Arrabbiata Pasta 🌶️", price: "310", img: "images/Food/Pasta_Noodles/Arrabbiata pasta.jpeg", desc: "Pasta tossed in fresh and spicy tomato red gravy" },
    { section: "food", cat: "Pasta/Noodles", name: "Green Pesto Cream Pasta ⭐", price: "400", img: "images/Food/Pasta_Noodles/Green pesto creamy pasta.jpeg", desc: "Pasta tossed with in-house fresh basil creamy pesto sauce" },
    // { section: "food", cat: "Pasta/Noodles", name: "Mushroom Sauce Pasta", price: "320", img: "images/Food/Pasta_Noodles/Mushroom sauce Pasta.jpeg", desc: "Pasta tossed with a creamy and cheesy mushroom sauce" },
    { section: "food", cat: "Pasta/Noodles", name: "Vegetable Noodles", price: "210", img: "images/Food/Pasta_Noodles/Vegetable Noodles.jpeg", desc: "Noodles tossed with fresh veggies and flavorful spices" },
    //  { section: "food", cat: "Pasta/Noodles", name: "Schezwan Noodles", price: "250", img: "images/Food/Pasta_Noodles/Schezwan Noodles.jpeg", desc: "Noodles tossed with tomato schezwan sauce" },
    { section: "food", cat: "Pasta/Noodles", name: "Burnt Garlic Noodles ⭐", price: "250", img: "images/Food/Pasta_Noodles/Burnt Garlic Noodles.jpeg", desc: "Noodles tossed with in-house smoky and garlicky flavored sauce" },
    // { section: "food", cat: "Pasta/Noodles", name: "Singapori Noodles 🌶️", price: "290", img: "images/Food/Pasta_Noodles/Singapuri Noodles.jpeg", desc: "Noodles tossed with sauté paneer and cashews with a twist of spices" },
    { section: "food", cat: "Pasta/Noodles", name: "Hakka Noodles", price: "280", img: "images/Food/Pasta_Noodles/Hakka Noodles.jpeg", desc: "Noodles tossed with paneer and mushroom" },

    // ── BRUSCHETTA ────────────────────────────────────────────
    // { section: "food", cat: "Bruschetta", name: "Italian Classic Bruschetta ⭐", price: "250", img: "images/Food/Bruschetta/Indian classic Bruschetta.jpeg", desc: "Sourdough topped with tomato in garlicky olive oil with cheese" },
    ...
    // { section: "food", cat: "Bruschetta", name: "Green Pesto Bruschetta", price: "300", img: "images/Food/Bruschetta/Green Pesto bruschetta.jpeg", desc: "Sourdough topped with green pesto, tomato in garlicky olive oil, and parmesan cheese" },
    // { section: "food", cat: "Bruschetta", name: "Avocado Bruschetta ⭐", price: "350", img: "images/Food/Bruschetta/Avocado bruschetta.jpeg", desc: "Sourdough topped with Guacamole and tossed garlicky tomato" },
    // { section: "food", cat: "Bruschetta", name: "Spinach Bruschetta", price: "250", img: "images/Food/Bruschetta/Spinach bruschetta.jpeg", desc: "Sourdough topped with spinach and garlic tossed with tomato and virgin olive oil" },
    // { section: "food", cat: "Bruschetta", name: "Cheese Mushroom Bruschetta ⭐", price: "280", img: "images/Food/Bruschetta/Cheese Musroom bruschetta.jpeg", desc: "Sourdough topped with cheesy mixture of mushroom and garlic" },

    // ── MOONGLET ──────────────────────────────────────────────
    // { section: "food", cat: "Moonglet", name: "Classic Moonglet", price: "150", img: "images/Food/Moonglet/Classic Moonglet.jpeg", desc: "Healthy moong dal with spices, onion, garlic, and curry leaves" },
    // { section: "food", cat: "Moonglet", name: "Paneer Moonglet ⭐", price: "180", img: "images/Food/Moonglet/Paneer Moonglet.jpeg", desc: "Moung dal filled with fresh in-house paneer and organic spices" },

    // ── SANDWICH ──────────────────────────────────────────────
    { section: "food", cat: "Sandwich", name: "Coleslaw Sandwich", price: "150", img: "images/Food/Sandwiches/Coleslaw_sandwitch.jpeg", desc: "Multigrain bread with loaded fresh cucumber, carrot, infused with in-house cheese sauce" },
    { section: "food", cat: "Sandwich", name: "Hummus Sandwich", price: "250", img: "images/Food/Sandwiches/Hummus_sandwitch.jpeg", desc: "In-house fresh hummus served with a tomato twist on multigrain bread" },
    { section: "food", cat: "Sandwich", name: "Bombay Sandwich", price: "250", img: "images/Food/Sandwiches/Bombay_sandwitch.jpeg", desc: "Indian twist spices with potato, onion & tomato served with grilled multigrain bread" },
    { section: "food", cat: "Sandwich", name: "Paneer Tandoori Sandwich ⭐", price: "270", img: "images/Food/Sandwiches/Paneer tandoori sandwitch.jpeg", desc: "In-house tandoori sauce filled with paneer served with multigrain bread" },
    { section: "food", cat: "Sandwich", name: "Tandoori Soya Sandwich", price: "199", img: "images/Food/Sandwiches/Tandoori_soya.jpeg", desc: "Multigrain sandwich with in-house cheese sauce, lettuce, tomato, and cucumber" },
    { section: "food", cat: "Sandwich", name: "Classic Grilled Sandwich", price: "150", img: "images/Food/Sandwiches/Classic_grilled.jpeg", desc: "Grilled multigrain sandwich with in-house cheese sauce and fresh veggies" },
    { section: "food", cat: "Sandwich", name: "Peri Peri Veg Crunch", price: "200", img: "images/Food/Sandwiches/Peri peri veg crunch.jpeg", desc: "Crispy exotic veggies tossed in bold in-house peri peri spice, packed into multigrain bread — crunchy, spicy, and satisfying" },

    // ── FRENCH FRIES ──────────────────────────────────────────
    // { section: "food", cat: "French Fries", name: "Classic Salted French Fries", price: "120", img: "images/Food/French Fries/Classic salted French fries.jpeg", desc: "Classic fries seasoned with salt" },
    // { section: "food", cat: "French Fries", name: "Peri Peri French Fries", price: "170", img: "images/Food/French Fries/Peri peri French fries.jpeg", desc: "Fries seasoned with in-house peri peri spice" },
    // { section: "food", cat: "French Fries", name: "Cheese Mexican Fries", price: "210", img: "images/Food/French Fries/Cheese Mexican fries.jpeg", desc: "Fries served with in-house cheese sauce" },
    // { section: "food", cat: "French Fries", name: "Schezwan French Fries", price: "190", img: "images/Food/French Fries/Schezwan French fries.jpeg", desc: "Fries seasoned with spicy schezwan sauce" },

    // ── TOASTS ────────────────────────────────────────────────
    // { section: "food", cat: "Toasts", name: "Chilli Mushroom Toast", price: "290", img: "images/Food/Toasts/Chilli mushroom toast.jpeg", desc: "Sliced mushrooms baked in spicy in-house sauce served on sourdough" },
    // { section: "food", cat: "Toasts", name: "Chilli Cheese Garlic Toast", price: "280", img: "images/Food/Toasts/Chilli cheese garlic toast.jpeg", desc: "In-house chilli cheese garlic sauce baked with veggies on sourdough" },
    // { section: "food", cat: "Toasts", name: "Veggie Exotic Toast", price: "300", img: "images/Food/Toasts/Veggie exotic toast.jpeg", desc: "Exotic seasonal vegetables tossed in olive oil, baked with in-house cheese on sourdough" },
    // { section: "food", cat: "Toasts", name: "Avocado Toast ⭐", price: "320", img: "images/Food/Toasts/Avocado toast.jpeg", desc: "Avocado seasoned in guacamole process and baked on sourdough" },
    // { section: "food", cat: "Toasts", name: "Caramelised Onion Mushroom ⭐", price: "300", img: "images/Food/Toasts/Caramelised onion mushroom.jpeg", desc: "Sliced onion and mushrooms caramelised in butter and olive oil, seasoned with TTR spices on sourdough" },

    // ── SALADS ────────────────────────────────────────────────
    { section: "food", cat: "Salads", name: "Weight Gain Salad", price: "320", img: "images/Food/Salads/Weight gain salad.jpeg", desc: "Peanuts, chickpea, grilled Paneer, cucumber, berries, olives, bell peppers, sweet corn, basil, lettuce, TTR dressing. (~700 kcal, 41g Protein)" },
    { section: "food", cat: "Salads", name: "Weight Loss Salad ⭐", price: "420", img: "images/Food/Salads/Weight loss salad.jpeg", desc: "Broccoli, grilled Tofu, walnuts, Basil pesto, Chia seeds, Almonds, TTR dressing. (~250 kcal, 20g Protein)" },
    { section: "food", cat: "Salads", name: "Protein Chaat", price: "250", img: "images/Food/Salads/Protein chaat salad.jpeg", desc: "Tomato, boiled moong, Imli chutney, Chickpea, Rajma, curd, TTR dressing. (~360 kcal, 20g Protein)" },
    { section: "food", cat: "Salads", name: "Classic Fruit Salad", price: "299", img: "images/Food/Salads/Classic fruit salad.jpeg", desc: "Seasonal fresh fruits seasoned with taste twist" },

    // ── MILLET PANCAKES ───────────────────────────────────────
    // { section: "food", cat: "Millet Pancakes", name: "Classic Pancake", price: "299", img: "images/Food/Millet Pancakes/Classic pancakes.jpg.jpeg", desc: "A classic preparation of millet based pancake" },
    // { section: "food", cat: "Millet Pancakes", name: "Banana Choco Chip ⭐", price: "330", img: "images/Food/Millet Pancakes/Banana choco chip pancakes.jpg.jpeg", desc: "Millet based pancake loaded with banana and choco chips" },
    // { section: "food", cat: "Millet Pancakes", name: "Chocolate Pancake", price: "320", img: "images/Food/Millet Pancakes/Chocolate pancakes.jpg.jpeg", desc: "Millet based pancake with dark chocolate syrup—perfect for chocolate lovers" },
    // { section: "food", cat: "Millet Pancakes", name: "Blueberry Pancake ⭐", price: "350", img: "images/Food/Millet Pancakes/Blueberry pancakes.jpg.jpeg", desc: "Millet based pancake loaded with a refreshing taste of authentic blueberry" },
