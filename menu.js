...
const menuData = [
    ...
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Mediterranean Tomato Broccoli", price: "279", img: "images/Mediterranean tomato brocolli.jpeg", desc: "Sun-kissed tomatoes and tender broccoli tossed in Mediterranean herbs and olive oil, wrapped in warm organic parathas — light, vibrant, and wholesomely satisfying" },
    { section: "food", cat: "Indo-European Paratha Bowls", name: "Guacamole", price: "349", img: "images/Guacamole parantha.jpeg", desc: "Creamy, freshly made guacamole with ripe avocado, lime, and herbs, wrapped in warm organic parathas — smooth, rich, and deliciously wholesome" },
    // ── DESI PARATHA BOWLS ────────────────────────────────────
    { section: "food", cat: "Desi Paratha Bowls", name: "Shahi Paneer Makhani 👑", price: "380", img: "images/Shahi paneer makhni parantha bowl.jpeg", desc: "Velvety shahi paneer slow-cooked in a rich, aromatic makhani gravy — regal, buttery, and soul-satisfying, wrapped in warm organic parathas" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Palak Paneer 💪 (High Protein) 👨‍🍳", price: "280", img: "images/palak paneer parantha bowl.jpeg", desc: "Farm-fresh spinach blended with soft organic paneer — packed with protein, earthy green goodness, and nourishing desi warmth" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Malai Kofta", price: "310", img: "images/malai kofta parantha bowl.jpeg", desc: "Melt-in-the-mouth koftas simmered in a creamy, mildly spiced malai gravy — indulgent, rich, and rooted in classic desi comfort" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Kaju Curry", price: "320", img: "images/kaju curry parantha bowl.jpeg", desc: "Plump cashews slow-cooked in a velvety, aromatic curry — nutty, luxurious, and deeply satisfying with every wholesome bite" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Rajma Chola Masala", price: "260", img: "images/Rajma chola masala parantha bowl.jpeg", desc: "A hearty, spiced blend of slow-cooked rajma and chola, served in a warm paratha bowl for the ultimate desi comfort" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Kadhai Paneer ⭐ (Chef Special) 👨‍🍳", price: "329", img: "images/kadhai paneer parantha bowl.jpeg", desc: "Paneer tossed in a bold, smoky kadhai masala with bell peppers and whole spices — the chef's pride, fiery, and organically irresistible" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Butter Paneer Masala", price: "320", img: "images/butter paneer masala parantha bowl.jpeg", desc: "Tender paneer cubes bathed in a luscious, buttery tomato masala — smooth, warming, and a timeless desi classic" },
    { section: "food", cat: "Desi Paratha Bowls", name: "Mix Veg", price: "299", img: "images/mix veg parantha bowl.jpeg", desc: "A wholesome medley of seasonal vegetables slow-cooked in desi spices — vibrant, hearty, and rooted in the goodness of nature" },
    ...
    { section: "food", cat: "Rice Bowls", name: "Garlic Soy Butter Broccoli", price: "399", img: "images/Garlic soy butter rice bowl.jpeg", desc: "Tender broccoli tossed in garlic, soy & butter over organic rice — rich in fiber, wholesome, and deeply satisfying" },

    // ── APPETIZERS ──────────────────────────────────────────────
    { section: "food", cat: "Quick Bites", name: "Garlic Bread", price: "199", img: "images/Garlic bread.jpeg", desc: "Freshly toasted sourdough slices infused with aromatic garlic butter and mixed Italian herbs." },
    ...
    { section: "food", cat: "Quick Bites", name: "Makhana Bhel", price: "260", img: "images/Makhana bhel.jpeg", desc: "Crispy roasted makhana tossed with fresh veggies, and TTR's signature spice blend — light, crunchy, and guilt-free snacking at its best" },
    { section: "food", cat: "Quick Bites", name: "Shahi Paneer Tikka", price: "299", img: "images/Shahi paneer tikka.jpeg", desc: "Tender paneer cubes marinated in a rich, aromatic shahi spice mix and grilled to perfection — smoky, creamy, and royally indulgent in every bite" },
    { section: "food", cat: "Quick Bites", name: "Galouti Kebab", price: "229", img: "images/Galauti kebab.jpeg", desc: "Melt-in-the-mouth chana galouti kebab — soft, richly spiced, and slow-cooked with aromatic desi masalas for a truly royal bite" },
    { section: "food", cat: "Quick Bites", name: "Protein Galouti Kebab 💪", price: "259", img: "images/Protein galauti kebab.jpeg", desc: "A high-protein twist on the classic — soft, melt-in-the-mouth kebab crafted with fresh paneer and aromatic desi spices, indulgent yet nourishing in every bite" },
    // ── PIZZA ─────────────────────────────────────────────────────
    // — Sourdough —
    ...
    // ── PASTA/NOODLES ─────────────────────────────────────────────────
    // { section: "food", cat: "Pasta/Noodles", name: "Aglio e Olio Pasta", price: "300", img: "images/Agglio è olio pasta.jpg.jpeg", desc: "Pasta boiled al dente and tossed with garlic and olive oil" },
